...
const ModalMakeSupport = ({ intl, users, generateGroupReport, generateVaultReport, data, trigger, type, user, generateUserReport, generateActivityReport }) => {
    ...
    return (
        <ModalWrap title='sendStructure' icon='file alternate outline' trigger={trigger || defaultTrigger}>
            {({ closeModal }) => (
                <>
                    <Message
...
export default ModalMakeSupport;
